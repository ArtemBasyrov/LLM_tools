...
SYSTEM_PROMPT = (
    ...
    "Do NOT re-run the original tool. "
    "Do NOT use bash commands (cat, head, tail, grep, etc.) to read the scratch file — "
    "bash is not a registered tool and will fail or bypass context management. "
    "Use ONLY the read_file tool with start_line/end_line to retrieve specific sections, "
    "or the search_file tool with a regex pattern to locate content. "
